...
Please read the #HASHCORE best practices, go to [#HASHCORE - Best Practices](http://hashcore.com/hashcore-best-practices).

== Screenshots ==

1. Hashcore Settings - Add your Twitter username and publisher ID.
2. Add known hashtags in your content e.g. #Xfactor
3. Twitter feeds from #HASHCORE displayed in a lightbox when users click on hashtags.
